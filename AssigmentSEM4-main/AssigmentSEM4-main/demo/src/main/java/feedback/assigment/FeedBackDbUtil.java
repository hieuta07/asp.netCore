...
public class FeedBackDbUtil {
    ...
    public List<FeedBack> getFeedBacks() throws Exception {
        ...
        try {
            // get a connection
            String url = "jdbc:mysql://localhost:3306/coffee_manager";
...
//			myConn = dataSource.getConnection();
            ...
            while (myRs.next()) {
                ...
                FeedBack tempFeedBack = new FeedBack(id, email, subject, message);
...
//			myConn = dataSource.getConnection();
            ...
            myStmt.setString(1, theFeedBack.getEmail());
            myStmt.setString(2, theFeedBack.getSubject());
            myStmt.setString(3, theFeedBack.getMessage());
...
//			myConn = dataSource.getConnection();
            ...
            if (myRs.next()) {
                ...
                theFeedBack = new FeedBack(feedBackId, email, subject, message);
            }
            else {
...
//			myConn = dataSource.getConnection();
            ...
            myStmt.setString(2, theFeedBack.getSubject());
            myStmt.setString(3, theFeedBack.getMessage());
            myStmt.setInt(4, theFeedBack.getId());
